# SimpleCast 0.9.0 beta 8 build provenance
...
Compress-Archive -Path .\dist\SimpleCast `
  -DestinationPath .\SimpleCast-Windows-x64-v0.9.0-beta.8-portable.zip `
  -CompressionLevel Optimal
Get-FileHash -Algorithm SHA256 `
  .\installer\output\SimpleCast-Setup-0.9.0-beta.8-x64.exe, `
  .\SimpleCast-Windows-x64-v0.9.0-beta.8-portable.zip, `
