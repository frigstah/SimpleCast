# SimpleCast 0.9.0 beta 5 build provenance
...
Compress-Archive -Path .\dist\SimpleCast `
  -DestinationPath .\SimpleCast-Windows-x64-v0.9.0-beta.5-portable.zip `
  -CompressionLevel Optimal
Get-FileHash -Algorithm SHA256 `
  .\installer\output\SimpleCast-Setup-0.9.0-beta.5-x64.exe, `
  .\SimpleCast-Windows-x64-v0.9.0-beta.5-portable.zip, `
...
Control may warn users. The in-app updater verifies the installer against the
SHA-256 digest returned for the official GitHub release asset before launching
it.
