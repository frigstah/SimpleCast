# SimpleCast 0.9.0 beta 15 build provenance
...
SimpleCast source and its native process-loopback helper. They do not replace
the corresponding-source obligations for the separately bundled FFmpeg
executable.
...
Compress-Archive -Path .\dist\SimpleCast `
  -DestinationPath .\SimpleCast-Windows-x64-v0.9.0-beta.15-portable.zip `
  -CompressionLevel Optimal
Get-FileHash -Algorithm SHA256 `
  .\installer\output\SimpleCast-Setup-0.9.0-beta.15-x64.exe, `
  .\SimpleCast-Windows-x64-v0.9.0-beta.15-portable.zip, `
